...
int main(int nargs, char* argv[])
{
	...
	// photon yield
        ...
        TH1F *Nph_tree_SouthLower          = new TH1F("Nph_tree_SouthLower","number of hits", 1001,-.5,1000.5);
        TH1F *Nph_cut_tree_SouthLower      = new TH1F("Nph_cut_tree_SouthLower","number of hits (selection)", 1001,-.5,1000.5);
        TH1F *Nph_cut_pion_tree_SouthLower = new TH1F("Nph_cut_pion_tree_SouthLower","number of photons (pion selection)", 1001,-.5,1000.5);
        TH1F *Nph_cut_kaon_tree_SouthLower = new TH1F("Nph_cut_kaon_tree_SouthLower","number of photons (kaon selection)", 1001,-.5,1000.5);

        TH1F *Nph_tree_NorthUpper          = new TH1F("Nph_tree_NorthUpper","number of hits", 1001,-.5,1000.5);
        TH1F *Nph_cut_tree_NorthUpper      = new TH1F("Nph_cut_tree_NorthUpper","number of hits (selection)", 1001,-.5,1000.5);
        TH1F *Nph_cut_pion_tree_NorthUpper = new TH1F("Nph_cut_pion_tree_NorthUpper","number of photons (pion selection)", 1001,-.5,1000.5);
        TH1F *Nph_cut_kaon_tree_NorthUpper = new TH1F("Nph_cut_kaon_tree_NorthUpper","number of photons (kaon selection)", 1001,-.5,1000.5);
	...
	TH1F* hMap_dist_theta[NumPBins][NumBars][NumXBins];
	TH1F* hMap_dist_phi[NumPBins][NumBars][NumXBins];

	// Nph
	TH1F* hMap_Nph_pion_near_tree[NumPBins][NumBars][NumXBins];
	TH1F* hMap_Nph_kaon_near_tree[NumPBins][NumBars][NumXBins];
	TH1F* hMap_Nph_pion_away_tree[NumPBins][NumBars][NumXBins];
	TH1F* hMap_Nph_kaon_away_tree[NumPBins][NumBars][NumXBins];

	TH1F* hMap_Nph_pion_sim[NumPBins][NumBars][NumXBins];
	...
	// DLL
	TH1F* hMap_ll_diff_pion_tree[NumPBins][NumBars][NumXBins];
	TH1F* hMap_ll_diff_kaon_tree[NumPBins][NumBars][NumXBins];

	TH1F* hMap_ll_diff_pion_sim[NumPBins][NumBars][NumXBins];
	TH1F* hMap_ll_diff_kaon_sim[NumPBins][NumBars][NumXBins];


	// support points dist.
        TH1F* hMap_support_dist_t_pion_sim[NumPBins][NumBars][NumXBins];
        TH1F* hMap_support_dist_t_kaon_sim[NumPBins][NumBars][NumXBins];
	...
	for (int locPBin = 0 ; locPBin < NumPBins ; locPBin++ )
	{
		...
		for (int locXBin = 0 ; locXBin < NumXBins ; locXBin++ )
		{
			...
			locLabel_title = Form("P:(%2.01f, %2.01f) Bar %d x:(%3.01f, %3.01f)",\
						PBinEdges[locPBin][0],PBinEdges[locPBin][1],locBar,XBin_min,XBin_max);

			hMap_dist_theta[locPBin][locBar][locXBin] = new TH1F(\
									Form("dist_theta_%s",locLabel_name.c_str()),\
									Form("#theta, %s",locLabel_title.c_str()),\
									75,0.,15.);
			hMap_dist_phi[locPBin][locBar][locXBin] = new TH1F(\
									Form("dist_phi_%s",locLabel_name.c_str()),\
									Form("#phi, %s",locLabel_title.c_str()),\
									180,-180.,180.);

			hMap_Nph_pion_near_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_pion_near_tree_%s",locLabel_name.c_str()),\
									Form("Nph pion tree (near PDF), %s",locLabel_title.c_str()),\
									100,-0.5,99.5);
			hMap_Nph_kaon_near_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_kaon_near_tree_%s",locLabel_name.c_str()),\
									Form("Nph kaon tree (near PDF), %s",locLabel_title.c_str()),\
									100,-0.5,99.5);
			hMap_Nph_pion_away_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_pion_away_tree_%s",locLabel_name.c_str()),\
									Form("Nph pion tree (away from PDF), %s",locLabel_title.c_str()),\
									100,-0.5,99.5);
			hMap_Nph_kaon_away_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_kaon_away_tree_%s",locLabel_name.c_str()),\
									Form("Nph kaon tree (away from PDF), %s",locLabel_title.c_str()),\
									100,-0.5,99.5);

			hMap_Nph_pion_sim[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_pion_sim_%s",locLabel_name.c_str()),\
									Form("Nph sim, %s",locLabel_title.c_str()),\
									100,-0.5,99.5);
			hMap_Nph_kaon_sim[locPBin][locBar][locXBin] = new TH1F(\
									Form("Nph_kaon_sim_%s",locLabel_name.c_str()),\
									Form("Nph sim, %s",locLabel_title.c_str()),\
									100,-0.5,99.5);
		        ...
		        hMap_hit_dist_t_pion_near_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("hit_dist_t_pion_near_tree_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
		        hMap_hit_dist_t_kaon_near_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("hit_dist_t_kaon_near_tree_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
		        hMap_hit_dist_t_pion_away_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("hit_dist_t_pion_away_tree_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
		        hMap_hit_dist_t_kaon_away_tree[locPBin][locBar][locXBin] = new TH1F(\
									Form("hit_dist_t_kaon_away_tree_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
		        ...
		        hMap_support_dist_t_pion_sim[locPBin][locBar][locXBin] = new TH1F(\
									Form("support_dist_t_pion_sim_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
		        hMap_support_dist_t_kaon_sim[locPBin][locBar][locXBin] = new TH1F(\
									Form("support_dist_t_kaon_sim_%s",locLabel_name.c_str()),\
									Form("hit time %s;t (ns);",locLabel_title.c_str()),\
									450,0,450);
			...
			hMap_ll_diff_pion_tree[locPBin][locBar][locXBin] = new TH1F(\
							Form("ll_diff_pion_tree_%s",locLabel_name.c_str()),\
							Form("DLL %s",locLabel_title.c_str()),\
							200000,-200,200);
			hMap_ll_diff_kaon_tree[locPBin][locBar][locXBin] = new TH1F(\
							Form("ll_diff_kaon_tree_%s",locLabel_name.c_str()),\
							Form("DLL %s",locLabel_title.c_str()),\
							200000,-200,200);

			hMap_ll_diff_pion_sim[locPBin][locBar][locXBin] = new TH1F(\
							Form("ll_diff_pion_sim_%s",locLabel_name.c_str()),\
							Form("DLL %s",locLabel_title.c_str()),\
							200000,-200,200);
			hMap_ll_diff_kaon_sim[locPBin][locBar][locXBin] = new TH1F(\
							Form("ll_diff_kaon_sim_%s",locLabel_name.c_str()),\
							Form("DLL %s",locLabel_title.c_str()),\
							200000,-200,200);
		}
	}
	...
	int Nph_total_tree = -1;
		...
		for (int particle_i = 0; particle_i < particle_array->GetEntriesFast(); particle_i++)
		{
			...
			if (locSouthLower && particle_bar_tree != int(particle_bar))
				continue;
			if (!locSouthLower && particle_bar_tree != int(particle_bar+24))
				continue;
			...
			if (smear_time == true)
			{
				...
				{
					support_points_pion[loc_i].t += rand_gen->Gaus(0.,1.);
				}
				for (unsigned int loc_i = 0 ; loc_i < support_points_kaon.size(); loc_i++ )
				{
					support_points_kaon[loc_i].t += rand_gen->Gaus(0.,1.5);
				}
			}


	                ll_pion = pdf_pion->get_log_likelihood(support_points_pion,tree_points);
			...
			for (unsigned int i = 0; i < tree_points.size(); i++)
			{
				if (tree_points[i].cut==false)
				{
					...
					if (locBin_PID == 0)
					{
		        			hMap_hit_dist_t_pion_near_tree[locBin_P][locBin_Bar][locBin_X]->Fill(tree_points[i].t);
						hMap_hit_dist_rowcol_pion_near_tree[locBin_P][locBin_Bar][locBin_X]->Fill(\
												tree_points[i].pixel_row,\
												tree_points[i].pixel_col);
					}
				}
				else
				{
			...
			if (locBin_PID == 0)
			{
				...
				else
				{
	                	...
	                	hMap_Nph_pion_near_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(Ngoodhit_counter_pion);
	                	hMap_Nph_pion_away_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(Nph_total_tree - Ngoodhit_counter_pion);
			}




        	        ll_kaon = pdf_kaon->get_log_likelihood(support_points_kaon,tree_points);
			...
			for (unsigned int i = 0; i < tree_points.size(); i++)
			{
				if (tree_points[i].cut==false)
				{
					...
					hit_dist_t_cut_tree->Fill(tree_points[i].t);

					if (locBin_PID == 1)
					{
		        			hMap_hit_dist_t_kaon_near_tree[locBin_P][locBin_Bar][locBin_X]->Fill(tree_points[i].t);
				...
				else
				{
	                	...
	                	hMap_Nph_kaon_near_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(Ngoodhit_counter_kaon);
	                	hMap_Nph_kaon_away_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(Nph_total_tree - Ngoodhit_counter_kaon);
                        }


			hMap_dist_theta[locBin_P][locBin_Bar][locBin_X]->Fill(particle_p3_tree.Theta()*rad2deg);
			hMap_dist_phi[locBin_P][locBin_Bar][locBin_X]->Fill(particle_p3_tree.Phi()*rad2deg);

			if (locBin_PID == 0)
			{
                		ll_diff_pion_tree->Fill(ll_pion-ll_kaon);

				hMap_ll_diff_pion_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(ll_pion - ll_kaon);
			...
			if (locBin_PID == 1)
			{
				...
				hMap_ll_diff_kaon_tree[locBin_P][locBin_Bar][locBin_X] -> Fill(ll_pion - ll_kaon);
			...
			// Studies with simulated hits
				...
				hMap_Nph_pion_sim[locBin_P][locBin_Bar][locBin_X] -> Fill(int(sim_points_pion.size()));

				ll_pion = pdf_pion->get_log_likelihood(support_points_pion,sim_points_pion);
				ll_kaon = pdf_kaon->get_log_likelihood(support_points_kaon,sim_points_pion);
				hMap_ll_diff_pion_sim[locBin_P][locBin_Bar][locBin_X] -> Fill(ll_pion - ll_kaon);
				...
				hMap_Nph_kaon_sim[locBin_P][locBin_Bar][locBin_X] -> Fill(int(sim_points_kaon.size()));

				ll_pion = pdf_pion->get_log_likelihood(support_points_pion,sim_points_kaon);
				ll_kaon = pdf_kaon->get_log_likelihood(support_points_kaon,sim_points_kaon);
				hMap_ll_diff_kaon_sim[locBin_P][locBin_Bar][locBin_X] -> Fill(ll_pion - ll_kaon);
			...
			for (unsigned int loc_i = 0 ; loc_i < support_points_pion.size(); loc_i++ )
			{
				...
				else
				{
					...
					hMap_support_dist_rowcol_pion_sim[locBin_P][locBin_Bar][locBin_X]->Fill(\
											support_points_pion[loc_i].pixel_row,\
			...
			for (unsigned int loc_i = 0 ; loc_i < support_points_kaon.size(); loc_i++ )
			{
				...
				else
				{
					...
					hMap_support_dist_rowcol_kaon_sim[locBin_P][locBin_Bar][locBin_X]->Fill(\
											support_points_kaon[loc_i].pixel_row,\
